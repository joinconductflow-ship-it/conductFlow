...
export function Card({ children, tone = "neutral", padded = true, interactive = false, style, className }: {
  ...
  const t = TONE[tone];
  return (
    <section className={[interactive && "cf-card-interactive", className].filter(Boolean).join(" ") || undefined} style={{
